                    ...
                    <div class="card workshopcard">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-8">
                                    <div class="h5 mb-0"><strong>Beaver Level 2: 2 to 4 months old. <small> $129</small>  </strong> </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Questions? Book an Appointment</h5>
